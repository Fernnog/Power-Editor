...
const TINYMCE_CONFIG = {
    ...
    // ATUALIZADO: 'customReplaceButton' removido conforme plano de simplificação
    toolbar: 'undo redo | blocks | bold italic underline | bullist numlist | alignjustify | customIndent customBlockquote | pagebreak visualblocks | customMicButton customGrammarFixButton | customPowerVariableButton | customPasteMarkdown customCopyFormatted customOdtButton | customThemeButton customDeleteButton',
    ...
    setup: function(editor) {
        ...
        editor.ui.registry.addIcon('custom-ai-brain', ICON_AI_BRAIN); // Mantido: O ícone será o "ABC" via ui-icons.js
        ...
        // Botão de correção gramatical via IA

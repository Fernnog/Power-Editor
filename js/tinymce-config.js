...
const TINYMCE_CONFIG = {
    ...
    setup: function(editor) {
        ...
        // Botão de Download (Modificado conforme Plano de Evolução)
        editor.ui.registry.addButton('customOdtButton', {
            ...
            onAction: function() {
                ...
                try {
                    // Solicita o nome do arquivo ao usuário via prompt nativo
                    let fileName = prompt("Digite o nome do arquivo para salvar:", "meu_documento");
                    
                    // Se o usuário clicar em Cancelar, interrompe a exportação
                    if (fileName === null) return; 
                    
                    // Trata o nome digitado e garante a extensão .md
                    fileName = fileName.trim();
                    if (fileName === '') fileName = 'documento_sem_nome';
